...
const Errors = require("../api/errors/codesandboxtemplate-main-error.js");
...
const logger = LoggerFactory.get("CodesandboxtemplateMainAbl");

class CodesandboxtemplateMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["codesandboxtemplateMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuCodesandboxtemplate",
        typeCode: "uu-codesandboxtemplate-maing01",
        location: location,
...
module.exports = new CodesandboxtemplateMainAbl();
